    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content tx-size-sm">
                ...
                <div class="row mg-b-25">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <textarea rows="3" class="form-control" placeholder="Actividad segun POAI o TDR"></textarea>
                        </div>
                    </div><!-- col-4 -->
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <textarea rows="3" class="form-control" placeholder="Resultado obtenido de la Actividad"></textarea>
                        </div>
                    </div><!-- col-4 -->
                    <div class="col-lg-2">
                        <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <div class="form-group mg-b-10-force">
                            ...
                            <input class="form-control" placeholder="Descripcion" type="text">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary tx-size-xs">Registrar Actividad</button>
